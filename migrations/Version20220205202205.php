 ...
 */
final class Version20220205202205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sale (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__entry AS SELECT id, shift_id, product_id, seller_id, amount, price, created FROM entry');
        ...
        $this->addSql('INSERT INTO entry (id, shift_id, product_id, seller_id, amount, price, created) SELECT id, shift_id, product_id, seller_id, amount, price, created FROM __temp__entry');
