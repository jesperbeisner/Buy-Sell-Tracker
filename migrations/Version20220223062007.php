 ...
 */
final class Version20220223062007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE map_position ADD COLUMN size INTEGER NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_2B219D708DE820D9 ON entry (seller_id)');
        $this->addSql('CREATE INDEX created_index ON entry (created)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__map_position AS SELECT id, x, y, created FROM map_position');
        $this->addSql('DROP TABLE map_position');
        $this->addSql('CREATE TABLE map_position (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, x INTEGER NOT NULL, y INTEGER NOT NULL, created DATETIME NOT NULL)');
        $this->addSql('INSERT INTO map_position (id, x, y, created) SELECT id, x, y, created FROM __temp__map_position');
        $this->addSql('DROP TABLE __temp__map_position');
        $this->addSql('DROP INDEX IDX_E54BC0054584665A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__sale AS SELECT id, product_id, name, amount, black_money, real_money, created FROM sale');
        $this->addSql('DROP TABLE sale');
