 ...
 */
final class Version20220205203127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__sale AS SELECT id FROM sale');
        ...
        $this->addSql('INSERT INTO sale (id) SELECT id FROM __temp__sale');
